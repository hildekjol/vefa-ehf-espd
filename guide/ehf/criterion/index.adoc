...
The two main groups of Criteria relevant for the ESPD are the ones required in the Directive, Exclusion and Selection criteria. This section gives a detailed view on how to specify each of those criteria. Its content is aligned to the http://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX%3A32016R0007[Annex to the Regulation 2016/7]
establishing the standard form for the European Single Procurement Document. #Korrekt norsk henvisning#

:leveloffset: +1

include::model.adoc[]
include::elements.adoc[]
include::legislation.adoc[]
include::requirement-group.adoc[]
